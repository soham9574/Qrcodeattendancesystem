...
<body>
    <div class="container">
        ...
        <div class="filter">
            ...
            <input readonly value="<?php echo $username ?>" type="text" id="filterTeacherid">
            ...
            <button onClick="location.replace('teacherdashboard.php')" id="backButton" class="btn btn-danger">Back</button>
            ...
            function applyFilter(data) {
                ...
                let filteredData = data.filter(function(row) {
                    return (filterYear === "" || row.Year === filterYear) &&
                           ...
                           (row.Teacherid.toLowerCase() === '<?php echo strtolower($username); ?>') &&
